...
INSTALLED_APPS = [
    ...
    'intercity.apps.IntercityConfig',
    'intracity.apps.IntracityConfig',
...
ECOCASH_BASE_URL = os.environ.get('ECOCASH_BASE_URL', 'https://developers.ecocash.co.zw/sandbox')
...
ECOCASH_SUPER_MERCHANT_NAME = os.environ.get('ECOCASH_SUPER_MERCHANT_NAME', 'EcoCash Sandbox')
ECOCASH_MERCHANT_NAME = os.environ.get('ECOCASH_MERCHANT_NAME', 'Test Merchant')
ECOCASH_NOTIFY_URL = os.environ.get('ECOCASH_NOTIFY_URL', 'https://myapp.example.com/webhook/eip')
